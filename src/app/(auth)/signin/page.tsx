  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#18181b] px-4 py-8">
      <div className="w-full max-w-[400px] bg-[#27272a] border border-[#3f3f46] rounded-2xl p-8">
        ...
        {/* Heading */}
        <div className="mb-6">
          <h1 className="text-[21px] font-semibold text-white tracking-tight mb-1">Welcome back</h1>
          <p className="text-[13px] text-[#71717a]">
            No account?{" "}
            <Link href="/signup" className="text-[#a3e635] font-medium hover:text-[#b4ef47] transition-colors">
              Sign up for free
            </Link>
          </p>
        </div>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-3.5">
              ...
              render={({ field }) => (
                <FormItem className="space-y-1">
                  <div className="flex items-center justify-between">
                    ...
                    <Link href="/forgot-password" className="text-[11px] text-[#52525b] hover:text-[#71717a] transition-colors">
                      Forgot password?
                    </Link>
                  </div>
                  <div className="relative">
                    <Input
                      ...
                      placeholder="••••••••"
                      {...field}
                      className="bg-[#18181b] border-[#3f3f46] focus:border-[#52525b] text-[#d4d4d8] placeholder:text-[#52525b] text-[13.5px] pr-9 rounded-lg h-9"
                    />
                    <button
                      type="button"
            ...
            <Button
              ...
              className={`w-full rounded-lg h-9 text-[13.5px] font-medium tracking-tight transition-colors border-0 ${
                success
            ...
            >
              {isSubmitting ? (
                <><Loader2 className="w-3.5 h-3.5 animate-spin mr-1.5" />Signing in...</>
              ) : success ? (
                <><Check className="w-3.5 h-3.5 mr-1.5" />Signed in!</>
              ) : "Sign in"}
            </Button>
        ...
        <button
          ...
          className="w-full bg-[#18181b] border border-[#3f3f46] hover:bg-[#3f3f46] rounded-lg h-9 text-[13px] font-medium text-[#d4d4d8] flex items-center justify-center gap-2 transition-colors cursor-pointer"
        >
